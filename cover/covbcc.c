 ...
 *	COVBCC.C
 *
 * C-source cover analyzer bcc-compiler driver.
 *
...
void main(int argc, char* argv[])
{
        ...
        if (argc == 1) {
            printf("Usage: covbcc [-C<cover options>] <bcc arguments ...>\n"
                   "Cover options:\n"
        ...
        *p = '\0';
        ...
        new_argv[empty_argv_pos] = "";
        display(new_argv);

#if 0   /* not valid for BORLANDC */
